...
int segment_triangle_inter(const Vector3d &ef0, const Vector3d &ef1, const Vector3d &tf1, const Vector3d &tf2, const Vector3d &tf3)
{
    ...
    const Rational d = e0[0] * t1[0] * t2[1] - e0[0] * t1[0] * t2[2] - e0[0] * t1[0] * t3[1] + e0[0] * t1[0] * t3[2] - e0[0] * t1[1] * t2[0] + e0[0] * t1[1] * t2[2] + e0[0] * t1[1] * t3[0] - e0[0] * t1[1] * t3[2] + e0[0] * t1[2] * t2[0] - e0[0] * t1[2] * t2[1] - e0[0] * t1[2] * t3[0] + e0[0] * t1[2] * t3[1] + e0[0] * t2[0] * t3[1] - e0[0] * t2[0] * t3[2] - e0[0] * t2[1] * t3[0] + e0[0] * t2[1] * t3[2] + e0[0] * t2[2] * t3[0] - e0[0] * t2[2] * t3[1] - e1[0] * t1[1] * t2[2] + e1[0] * t1[1] * t3[2] + e1[0] * t1[2] * t2[1] - e1[0] * t1[2] * t3[1] - e1[0] * t2[1] * t3[2] + e1[0] * t2[2] * t3[1] + e1[1] * t1[0] * t2[2] - e1[1] * t1[0] * t3[2] - e1[1] * t1[2] * t2[0] + e1[1] * t1[2] * t3[0] + e1[1] * t2[0] * t3[2] - e1[1] * t2[2] * t3[0] - e1[2] * t1[0] * t2[1] + e1[2] * t1[0] * t3[1] + e1[2] * t1[1] * t2[0] - e1[2] * t1[1] * t3[0] - e1[2] * t2[0] * t3[1] + e1[2] * t2[1] * t3[0];
    if(d.get_sign() == 0)
        return -1;

    const Rational t = (e0[0] * t1[0] * t2[1] - e0[0] * t1[0] * t2[2] - e0[0] * t1[0] * t3[1] + e0[0] * t1[0] * t3[2] - e0[0] * t1[1] * t2[0] + e0[0] * t1[1] * t2[2] + e0[0] * t1[1] * t3[0] - e0[0] * t1[1] * t3[2] + e0[0] * t1[2] * t2[0] - e0[0] * t1[2] * t2[1] - e0[0] * t1[2] * t3[0] + e0[0] * t1[2] * t3[1] + e0[0] * t2[0] * t3[1] - e0[0] * t2[0] * t3[2] - e0[0] * t2[1] * t3[0] + e0[0] * t2[1] * t3[2] + e0[0] * t2[2] * t3[0] - e0[0] * t2[2] * t3[1] - t1[0] * t2[1] * t3[2] + t1[0] * t2[2] * t3[1] + t1[1] * t2[0] * t3[2] - t1[1] * t2[2] * t3[0] - t1[2] * t2[0] * t3[1] + t1[2] * t2[1] * t3[0])/d;
    const Rational u = (-e0[0] * e1[0] * t1[1] + e0[0] * e1[0] * t1[2] + e0[0] * e1[0] * t3[1] - e0[0] * e1[0] * t3[2] + e0[0] * e1[1] * t1[0] - e0[0] * e1[1] * t1[2] - e0[0] * e1[1] * t3[0] + e0[0] * e1[1] * t3[2] - e0[0] * e1[2] * t1[0] + e0[0] * e1[2] * t1[1] + e0[0] * e1[2] * t3[0] - e0[0] * e1[2] * t3[1] - e0[0] * t1[0] * t3[1] + e0[0] * t1[0] * t3[2] + e0[0] * t1[1] * t3[0] - e0[0] * t1[1] * t3[2] - e0[0] * t1[2] * t3[0] + e0[0] * t1[2] * t3[1] + e1[0] * t1[1] * t3[2] - e1[0] * t1[2] * t3[1] - e1[1] * t1[0] * t3[2] + e1[1] * t1[2] * t3[0] + e1[2] * t1[0] * t3[1] - e1[2] * t1[1] * t3[0])/d;
    const Rational v = (e0[0] * e1[0] * t1[1] - e0[0] * e1[0] * t1[2] - e0[0] * e1[0] * t2[1] + e0[0] * e1[0] * t2[2] - e0[0] * e1[1] * t1[0] + e0[0] * e1[1] * t1[2] + e0[0] * e1[1] * t2[0] - e0[0] * e1[1] * t2[2] + e0[0] * e1[2] * t1[0] - e0[0] * e1[2] * t1[1] - e0[0] * e1[2] * t2[0] + e0[0] * e1[2] * t2[1] + e0[0] * t1[0] * t2[1] - e0[0] * t1[0] * t2[2] - e0[0] * t1[1] * t2[0] + e0[0] * t1[1] * t2[2] + e0[0] * t1[2] * t2[0] - e0[0] * t1[2] * t2[1] - e1[0] * t1[1] * t2[2] + e1[0] * t1[2] * t2[1] + e1[1] * t1[0] * t2[2] - e1[1] * t1[2] * t2[0] - e1[2] * t1[0] * t2[1] + e1[2] * t1[1] * t2[0])/d;
